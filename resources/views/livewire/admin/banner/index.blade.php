        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
            <div class="card position-sticky" style="top: 0">
                ...
                <div class="card-body">
                    <div class="row gutters">
                        <form
                            wire:submit.prevent="saveBanner(Object.fromEntries(new FormData($event.target)))">
                            <div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="field-wrapper">
                                        <input name="title" id="title" value="{{@$title}}"
                                               ...
                                               type="text">
                                        <div class="field-placeholder">عنوان بنر<span
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ma-t">
                                <div class="field-wrapper">
                                    ...
                                    <div class="field-placeholder">تصویر بنر<span class="text-danger">*</span>
                                    </div>
                                    ...
                                    <tr role="row" class="odd position-relative">
                                        ...
                                        <td>
                                            <div class="actions t1">
                                                ...
                                                <a href="javascript:0" wire:click="deleteConfirm({{$banner->id}})"
                                                   data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                ...
                                                <div class="form-check d-inline-flex">
                                                    <input
                                                        value="{{$banner->id}}" @if($banner->status !=0) checked
                                                        @endif
