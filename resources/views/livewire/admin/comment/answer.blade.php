        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="card position-sticky" style="top: 0">
                ...
                <div class="card-body">
                    <div class="row gutters">
                        <form
                            wire:submit.prevent="answer(Object.fromEntries(new FormData($event.target)))">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="field-wrapper" wire:ignore>
                    <textarea name="body" id="body"
                              class="form-control @error('body') error-input-border @enderror"
                              type="text">{{@$comment->body}}</textarea>
                                    <div class="field-placeholder text-warning">پاسخ ادمین</div>
