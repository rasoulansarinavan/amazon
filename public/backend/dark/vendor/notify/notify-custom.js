...
$('.add-success-noti').on('click', function () {
    notes.show("سفارش شما با موفقیت ثبت شد.", {
        type: 'success',
        title: 'سلام دوست عزیز',
        icon: '<i class="icon-sentiment_satisfied"></i>'
    });
});
$('.add-success-noti-admin').on('click', function () {
    notes.show("The Operation  Was Successfully", {
        type: 'success',
        title: 'Hello Friend',
        icon: '<i class="icon-sentiment_satisfied"></i>'
    });
...
$('.add-danger-noti-admin').on('click', function () {
    notes.show("Delete Operation Was Successfully", {
        type: 'danger',
        title: 'Hello Friend',
        icon: '<i class="icon-alert-triangle"></i>'
    });
