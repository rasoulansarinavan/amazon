...
class Create extends Component
{
    ...
    public $oldPhoto = '', $file, $category_id = '';
    public $fileExtension, $extensions = ['jpeg', 'jpg', 'png', 'gif'];
    public $title = '', $icon = '', $user_level_id;
    ...
    {
        $this->allCategory = Category::query()->with('category', 'image')->orderBy('category_id')->get();
    }
